...
const Navbar = () => {
  return (
    <nav class=" bg-sky-500 uppercase border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
      <div class="container flex flex-wrap justify-between items-center mx-auto px-5">
        ...
        <div class="flex md:order-1">
          <div class="hidden relative mr-3 md:mr-0 md:block w-96">
